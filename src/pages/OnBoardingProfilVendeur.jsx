...
function OnBoardingProfilVendeur() {
  ...
  async function sendSellerProfile() {
    ...
    const response = await fetch(
      `https://services.cacahuete.dev/api/lacaverne/sellers/create`,
      {
        method: "POST",
        headers: {
      ...
      <div className="flex-1 flex flex-col">
        <div className="text-center mb-8 mt-20">
          ...
          <p className="text-gray-300">
            Créez votre profil vendeur pour pouvoir vendre des articles sur le
            site
          </p>
        </div>
            ...
            <div className="w-[1250px] bg-white rounded-lg shadow-lg flex flex-col items-center justify-center">
              ...
              <div className="flex flex-col space-y-1 w-1/3">
                ...
                <textarea
                  maxLength={500}
                  placeholder={
                    "Des vendeurs passionnés pour des clients passionnés"
                  }
                  onChange={(e) => {
              ...
              <button
                ...
                className="disabled:opacity-50 disabled:cursor-not-allowed my-8 bg-[#346644] cursor-pointer text-white px-6 py-3 rounded-md w-1/3"
                onClick={sendSellerProfile}
              >
